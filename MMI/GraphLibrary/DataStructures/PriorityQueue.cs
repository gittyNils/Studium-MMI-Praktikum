...
namespace GraphLibrary.DataStructures
{
    ...
    /// </summary>
    /// <typeparam name="T">The values in the queue.  Must extend the PriorityQueueNode class</typeparam>
    public sealed class PriorityQueue<T> : IFixedSizePriorityQueue<T, double>
